...
/**
 * The shell's chrome. No directive on top and none needed: only
 * `components/crm-shell.tsx` carries one, and everything it imports is on the
 * client side of that boundary already.
 *
 * The interesting line is `StatusBar.Host`: the host of the runtime channel,
 * which is empty in the server's HTML by construction.
 */
    ...
    <div className="crm">
      <aside className="crm__side">
        <div className="crm__brand">
          Northwind CRM
          <small>create-slot · app router, RSC</small>
        </div>
        ...
        <div>
          ...
          <p className="muted" style={{ fontSize: 12, marginTop: 6 }}>
            A server decision, not a client one — read from a header the proxy
            set. Try <code>?plugins=pipeline,email</code>.
          </p>
        </div>
      </aside>
